...
public class AdapterData extends RecyclerView.Adapter<com.iotwae.monitoringmelon.pertumbuhan.Adapter.AdapterData.HolderData> {
    ...
    @NonNull
    @Override
    public com.iotwae.monitoringmelon.pertumbuhan.Adapter.AdapterData.HolderData onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_home_pembibitan, parent, false);
        com.iotwae.monitoringmelon.pertumbuhan.Adapter.AdapterData.HolderData holder = new com.iotwae.monitoringmelon.pertumbuhan.Adapter.AdapterData.HolderData(layout);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull com.iotwae.monitoringmelon.pertumbuhan.Adapter.AdapterData.HolderData holder, int position) {
