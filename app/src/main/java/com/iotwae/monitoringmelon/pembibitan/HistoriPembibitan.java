...
import com.iotwae.monitoringmelon.pembibitan.API.APIRequestHistory;
import com.iotwae.monitoringmelon.pembibitan.API.RetroServer;
import com.iotwae.monitoringmelon.pembibitan.Adapter.AdapterHistory;
...
public class HistoriPembibitan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_histori_pembibitan);
        ...
        dateText1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        HistoriPembibitan.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
...
//                    Collections.reverse(listData); //data card terbaru yang muncul diatas
                    ...
                    adData = new AdapterHistory(HistoriPembibitan.this, listData);
